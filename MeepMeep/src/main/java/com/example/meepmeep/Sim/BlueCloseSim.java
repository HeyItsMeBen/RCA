    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(-52, 52, Math.toRadians(140)))
                        ...
                        .setReversed(true)
                        .splineToSplineHeading(new Pose2d(-15, 10, Math.toRadians(180)), Math.toRadians(270))
                        .waitSeconds(0.5f)
                        ...
                        //get balls from gate
                        .setReversed(false)
                        .splineToSplineHeading(new Pose2d(-58,-10, Math.toRadians(160)), Math.toRadians(180))
                        .waitSeconds(0.5f)
                        ...
                        .setReversed(false)
                        .splineToConstantHeading(new Vector2d(-37, -35), Math.toRadians(180))
